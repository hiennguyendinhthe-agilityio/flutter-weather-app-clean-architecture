...
final bazUiAppTheme = ThemeData.light().copyWith(
...
final bazUiDarkTheme = ThemeData.dark().copyWith(
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    unselectedItemColor: _darkColorScheme.tertiary,
    selectedLabelStyle: BazUiTypographyFoundation.bodySmallMedium.copyWith(
      fontWeight: FontWeight.normal,
  ...
  /// ---------- Other Color ----------
  hintColor: _darkColorScheme.onPrimary,
  disabledColor: _darkColorScheme.secondaryContainer,
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ButtonStyle(
      ...
      iconColor: WidgetStateProperty.resolveWith(
        (Set<WidgetState> states) => _darkColorScheme.onPrimary,
      ),
      foregroundColor: WidgetStateProperty.resolveWith(
        (Set<WidgetState> states) => _darkColorScheme.onPrimary,
      ),
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    filled: true,
    fillColor: _darkColorScheme.onSecondary,
  ),
