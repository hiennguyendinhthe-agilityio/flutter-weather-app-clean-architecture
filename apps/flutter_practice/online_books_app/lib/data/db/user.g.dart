...
User _userDeserialize(
  ...
  final object = User(
    ...
    loginTime: reader.readDateTime(offsets[1]),
  );
  object.id = id;
  return object;
}
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> loginTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> loginTimeGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> loginTimeLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> loginTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByLoginTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loginTime', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByLoginTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByLoginTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loginTime', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByLoginTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loginTime', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByLoginTime() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, DateTime, QQueryOperations> loginTimeProperty() {
    return QueryBuilder.apply(this, (query) {
