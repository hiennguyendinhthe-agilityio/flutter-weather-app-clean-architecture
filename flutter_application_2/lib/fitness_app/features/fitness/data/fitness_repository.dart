...
import 'package:flutter_application_2/fitness_app/features/fitness/models/daily_fitness_data.dart';
import 'package:flutter_application_2/fitness_app/features/fitness/models/health_stats_data.dart';
...
class FitnessRepository {
  ...
  static HealthStatsData getCurrentHealthStats() {
    return const HealthStatsData(
      ...
      totalIndex: 64,
      userName: 'Jane',
      motivationalText: 'Jane keep it up!',
      activityLevels: [
        ActivityLevelData(
          name: 'Cycling',
          percentage: 48,
