...
const double _kPeekOffset  = 0.0;  // no horizontal offset, bars match horizontally
...
class CustomAnimatedBarChart extends StatefulWidget {
  ...
  @override
  State<CustomAnimatedBarChart> createState() =>
      _CustomAnimatedBarChartState();
}
...
class _ChartLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (_, constraints) {
      ...
      final chartHeight = constraints.maxHeight - _kXAxisHeight - _kTopPadding;
...
class _XAxisLabels extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (_, constraints) {
      final slotWidth = (constraints.maxWidth - _kGroupGap * (count - 1)) / count;
      final barWidth  = slotWidth * _kBarFraction;
